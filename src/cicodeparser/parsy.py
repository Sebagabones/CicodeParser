# Taken from https://github.com/python-parsy/parsy/blob/v2.2/src/parsy/__init__.py
# Mostly didnt want to deal with packaging with emacs (end goal is to use this in an emacs major mode)
